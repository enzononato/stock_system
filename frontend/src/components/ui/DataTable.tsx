...
export function DataTable<TData>({
  ...
  return (
    <div className={cn('surface-panel overflow-x-auto p-5 space-y-4', className)}>
      {/* Search Header Bar */}
      {showSearchInput && (
      ...
      {pagination ? (
        <div className="flex items-center justify-between gap-4 pt-1">
          <p className="text-caption text-muted-foreground num whitespace-nowrap">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-caption text-muted-foreground num px-2 py-1 rounded-md bg-surface-alt whitespace-nowrap">
