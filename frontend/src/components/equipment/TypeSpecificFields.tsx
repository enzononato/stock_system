...
interface FieldConfig {
  ...
  /** Validador usado por `validateTypeSpecificFields` (T3). Campo vazio é sempre considerado válido. */
  validate?: (value: string) => boolean
  /** Mensagem de erro exibida quando o campo foi preenchido e `validate` retorna false. */
  invalidMessage?: string
}

// T3: os campos de MAC (endereco_fisico, mac) e IP (ip, ip_snmp) declaram
// aqui sua máscara/validador — este é o lugar natural para isso, já que é
// aqui que cada tipo de equipamento define quais campos específicos existe.
// Nota fiscal não entra aqui: é um campo comum a todos os tipos, validado
// diretamente em RegisterItemPage.tsx.
...
/**
 * Valida os campos específicos preenchidos para o tipo informado.
 * Campos vazios são sempre válidos (T3: só valida o que foi preenchido) —
 * quem decide se um campo é obrigatório é a tela que consome este componente.
 * Retorna a primeira mensagem de erro encontrada, ou `null` se tudo estiver ok.
 */
