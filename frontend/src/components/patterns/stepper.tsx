            ...
            return (
              <li key={step.id ?? idx} className="flex-1 flex items-center gap-3">
                <button
                  ...
                  className={cn(
                    "flex items-center gap-2.5 text-left transition-colors duration-micro",
                ...
                >
                  ...
                  <div
                    className={cn(
                      "size-7 shrink-0 rounded-[4px] flex items-center justify-center text-xs font-mono font-semibold border transition-colors",
                      isCompleted && "bg-foreground text-background border-foreground font-semibold",
                      isCurrent && "border-foreground bg-surface text-foreground font-bold shadow-xs",
