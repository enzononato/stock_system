...
// Logo 3D interativo (raw three.js, sem @react-three/fiber). Carregado sob
// demanda via lazy() na LoginPage para manter o three.js fora do bundle
// principal. Porta fiel da referência: valores de câmera/iluminação são
// calibrados para o modelo /3d/logo.glb — não "melhorar".
