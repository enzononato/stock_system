...
export function UsersPage() {
  ...
  return <div className="space-y-7">
    ...
    <Section title="Usuários cadastrados" description={`${users.length} conta(s) encontrada(s).`}><DataTable data={users} columns={columns} rowKey={(u) => u.id} isLoading={isLoading} error={error} onRetry={() => void refetch()} clientPageSize={7} emptyTitle="Nenhum usuário cadastrado" /></Section>
