...
/**
 * Traduz um erro de rede/HTTP em uma mensagem legível ao usuário.
 * Prioriza o `detail` retornado pelo backend (regras de negócio, validações),
 * sem nunca expor stack traces ou objetos crus.
 */
