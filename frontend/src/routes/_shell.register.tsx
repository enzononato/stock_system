...
export const Route = createFileRoute("/_shell/register")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Cadastrar item no sistema corporativo de controle de estoque e patrimônio de TI." },
      { property: "og:title", content: "Cadastrar item · Controle de Estoque de TI" },
      { property: "og:description", content: "Cadastrar item no sistema corporativo de controle de estoque e patrimônio de TI." },
