...
export const Route = createFileRoute("/_shell/terms")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Termos no sistema corporativo de controle de estoque e patrimônio de TI." },
      { property: "og:title", content: "Termos · Controle de Estoque de TI" },
      { property: "og:description", content: "Termos no sistema corporativo de controle de estoque e patrimônio de TI." },
