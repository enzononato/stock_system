...
- [x] ChartsPage
- [x] RegisterItemPage / EditItemPage + TypeSpecificFields
- [x] RemovePage
- [x] PeripheralsPage + LinkPeripheralPage
- [x] LoanPage + ReturnPage + TermsPage + ConfirmacaoTermo
- [x] HistoryPage + ReportPage
...
- [x] Tela Gestor (1 e 5)
- [x] Tela RH (2 e 8)
- [x] Tela DP (3 e 9 + panorama)
- [x] Tela Admin/Segurança (7 — devolução de patrimônio)
- [x] Tela Financeiro (checklist)
- [x] Tela Contabilidade (checklist)
