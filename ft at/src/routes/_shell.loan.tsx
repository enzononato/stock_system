...
export const Route = createFileRoute("/_shell/loan")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Empréstimo no sistema corporativo de controle de estoque e patrimônio de TI." },
      { property: "og:title", content: "Empréstimo · Controle de Estoque de TI" },
      { property: "og:description", content: "Empréstimo no sistema corporativo de controle de estoque e patrimônio de TI." },
