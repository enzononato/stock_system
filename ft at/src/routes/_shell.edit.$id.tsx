...
export const Route = createFileRoute("/_shell/edit/$id")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Editar item no sistema corporativo de controle de estoque e patrimônio de TI." },
      { property: "og:title", content: "Editar item · Controle de Estoque de TI" },
      { property: "og:description", content: "Editar item no sistema corporativo de controle de estoque e patrimônio de TI." },
